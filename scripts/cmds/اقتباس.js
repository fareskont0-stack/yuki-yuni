module.exports = {
  ...
  onStart: async function ({ message, api, event }) {
    try {
      const dataList = [
        {
          ...
          link: "https://i.imgur.com/3W2Wq4W.jpg"
        },
        {
      ...
      // تفاعل القلب لإعلامك أن الأمر يعمل
      api.setMessageReaction("💖", event.messageID, () => {}, true);
    
      // تجهيز الرابط وجلب الصورة كـ Stream بطريقة صحيحة
      const stream = await global.utils.getStreamFromURL(randomItem.link);

      // إرسال النص والصورة معا في نفس الرسالة
      ...
      return message.reply("حدث خطا في تنفيذ الامر يرجى تواصل معا المطور Fares kouachi رقم واتساب 0793229194 🍓");
    }
  }
};
