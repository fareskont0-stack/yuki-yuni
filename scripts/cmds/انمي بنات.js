...
module.exports = {
  config: {
    name: "بنات_انمي",
    aliases: ["بنت_انمي", "anime"],
    version: "1.0.0",
    author: "Priyansh Rajput + ChatGPT",
    role: 0,
    shortDescription: {
      ar: "إرسال صورة أنمي عشوائية",
      en: "Random anime girl image"
    },
    longDescription: {
      ar: "يرسل صورة أنمي عشوائية.",
      en: "Send a random anime girl image."
    },
    category: "anime",
    guide: {
      ar: "{pn}",
  ...
  onStart: async function ({ api, event }) {
    try {
      const images = ["https://i.imgur.com/2iXk7mU.jpg",  
